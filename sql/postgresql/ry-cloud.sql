...
insert into sys_menu values('4', 'PLUS官网', '0', '4', 'https://gitee.com/JavaLionLi/BDS-Cloud', null, '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', now(), '', null, '若依官网地址');
-- 二级菜单
...
insert into sys_oss_config values (1, 'minio',  'bds',            'bds123',        'bds',             '', '127.0.0.1:9000',                '','N', '',            '0', '', 'admin', now(), 'admin', now(), NULL);
insert into sys_oss_config values (2, 'qiniu',  'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'bds',             '', 's3-cn-north-1.qiniucs.com',     '','N', '',            '1', '', 'admin', now(), 'admin', now(), NULL);
insert into sys_oss_config values (3, 'aliyun', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'bds',             '', 'oss-cn-beijing.aliyuncs.com',   '','N', '',            '1', '', 'admin', now(), 'admin', now(), NULL);
insert into sys_oss_config values (4, 'qcloud', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'bds-1250000000',  '', 'cos.ap-beijing.myqcloud.com',   '','N', 'ap-beijing',  '1', '', 'admin', now(), 'admin', now(), NULL);
insert into sys_oss_config values (5, 'image',  'bds',            'bds123',        'bds',             'image', '127.0.0.1:9000',           '','N', '',            '1', '', 'admin', now(), 'admin', now(), NULL);
